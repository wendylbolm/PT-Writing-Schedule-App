...
class DaysControllerTest < ActionController::TestCase
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post :create, day: { completed: @day.completed, date: @day.date, goal: @day.goal, notes: @day.notes }
    end
  ...
  test "should update day" do
    patch :update, id: @day, day: { completed: @day.completed, date: @day.date, goal: @day.goal, notes: @day.notes }
    assert_redirected_to day_path(assigns(:day))
  end
